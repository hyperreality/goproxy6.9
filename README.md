<img src="https://github.com/hyperreality/goproxy6.9/blob/master/docs/images/logo.jpg?raw=true" width="200"/>
...
[Download](https://github.com/hyperreality/goproxy6.9/releases) 

---  
  
[![stable](https://img.shields.io/badge/stable-stable-green.svg)](https://github.com/hyperreality/goproxy6.9/) [![license](https://img.shields.io/github/license/hyperreality/goproxy6.9.svg?style=plastic)]() [![download_count](https://img.shields.io/github/downloads/hyperreality/goproxy6.9/total.svg?style=plastic)](https://github.com/hyperreality/goproxy6.9/releases) [![download](https://img.shields.io/github/release/hyperreality/goproxy6.9.svg?style=plastic)](https://github.com/hyperreality/goproxy6.9/releases)  
  
**[中文手册](/README_ZH.md)**  

**[Full-platform graphical interface version](/gui/README.md)**  

**[Full platform SDK](https://github.com/hyperreality/goproxy6.9-sdk/blob/master/README.md)**
...
```shell  
curl -L https://raw.githubusercontent.com/hyperreality/goproxy6.9/master/install_auto.sh | bash  
```  
...
#### **1.Download proxy**  
Download address: https://github.com/hyperreality/goproxy6.9/releases  
```shell  
cd /root/proxy/  
wget https://github.com/hyperreality/goproxy6.9/releases/download/v6.0/proxy-linux-amd64.tar.gz  

```  
#### **2.Download the automatic installation script**  
```shell  
cd /root/proxy/  
wget https://raw.githubusercontent.com/hyperreality/goproxy6.9/master/install.sh  
chmod +x install.sh  
./install.sh  
```   
...
[docker](https://hub.docker.com/r/hyperreality/goproxy6.9)  
...
2. Tag the image:
```
sudo docker tag <id from previous step>  hyperreality/goproxy6.9:latest
```
3. Run! 
Just put your arguments to proxy binary in the OPTS environmental variable (this is just a sample http proxy):
```
sudo docker run -d --restart=always --name goproxy -e OPTS="http -p :33080" -p 33080:33080 hyperreality/goproxy6.9:latest
```
4. View logs:
```
...
Recommend go1.10.1.   
`go get github.com/hyperreality/goproxy6.9`   
use command cd to enter your go SRC directory   
then cd to enter `github.com/hyperreality/goproxy6.9`.    
...
### AliPay
<img src="https://github.com/hyperreality/goproxy6.9/blob/master/docs/images/alipay.jpg?raw=true" width="200"/>
  
### Wechat Pay
<img src="https://github.com/hyperreality/goproxy6.9/blob/master/docs/images/wxpay.jpg?raw=true" width="200"/>
