...
[点击下载](https://github.com/hyperreality/goproxy6.9/releases) 官方QQ交流群: 793015219 (2群), 189618940 (1群满)  
...
**[全平台SDK](https://github.com/hyperreality/goproxy6.9-sdk/blob/master/README_ZH.md)**
...
#### **1.下载proxy**  
下载地址:https://github.com/hyperreality/goproxy6.9/releases/latest   
下面以v6.2为例,如果有最新版,请使用最新版链接.   

```shell  
cd /root/proxy/  
wget https://github.com/hyperreality/goproxy6.9/releases/download/v6.2/proxy-linux-amd64.tar.gz  
```  
...
2. 镜像打标签:
```
sudo docker tag <上一步的结果ID> hyperreality/goproxy6.9:latest
```
3. 运行 
...
cd进入你的go src目录  
cd进入`github.com/hyperreality/goproxy6.9`即可.    
